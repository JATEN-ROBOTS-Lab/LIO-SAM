...
MESSAGE(STATUS "${PRT_WRN}GTSAM_ROOT=${GTSAM_ROOT}${PRT_RST}")
MESSAGE(STATUS "${PRT_WRN}GTSAM_DIR=${GTSAM_DIR}${PRT_RST}")
...
if(GTSAM_DIR)
  ...
  find_path(GTSAM_LIBRARY_DIRS libgtsam.so
    PATHS "${GTSAM_DIR}/lib" "${GTSAM_DIR}" NO_DEFAULT_PATH
    DOC "GTSAM link directories")
